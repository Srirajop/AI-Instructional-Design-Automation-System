...
### Powered by EwandzDigital AI Framework
...
- 🎥 YouTube Videos (Paste link to extract transcript)
- 🌐 Website URLs (Scrape text from blogs or articles)
- ✍️ Plain text (Paste directly)

**How to Extract Content:**
1. In the project workspace, find the **"Source Content"** section.
2. **For Files:** Drag-and-drop your file or click to browse.
3. **For Links:** Paste the YouTube or Website URL into the link box.
4. Click **"Extract"** — the system will process the source and convert it to AI-ready text.
5. Review the extracted text in the editor. You can clean up navigation menus or footers to improve AI accuracy.
...
1. In the document view, locate the **AI Assistant** chat panel on the right.
2. Type a natural language instruction:
   - *"Change the strategy for Module 3 to focus on branching scenarios"*
   - *"Rewrite the narration for Screen 2.3 to be more conversational"*
   - *"Add a knowledge check question to Module 5"*
3. Click **Send** — the system will intelligently identify the relevant section, apply the edit, and refresh the document.
4. Use the **History** tab to see previous versions and track changes.
